...
- **[Namespace ROS Topics](setup/host_and_software.md#robot-namespacing-setup)** - Set Namespace for multi-robot swarm ROS nodes and topics
- **[Flash Teensy Firmware](/operations/advanced/firmware_updates.md.md)** - Program the robot's microcontroller

Once you have done the above you can move on to the [startup procedure](operations/startup_procedure.md).
