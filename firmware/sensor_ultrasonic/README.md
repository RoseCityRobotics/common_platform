...
- Hook sensor to ULTRASONIC1 on Common Robotics Platform Main Board. Pin 1 VCC, Pin 2 Trigger, Pin 3 Echo, Pin 4 Ground. Looking at the RCR Common Robotics Platform board from the top, find the label "ULTRASONIC1" - Pin 1 is toward the U on ULTRASONIC1.
